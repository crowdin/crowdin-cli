...
describe('** in dest and context', () => {
  ...
  // Every occurrence is substituted. Replacing only
  ...
  // The tail after `**` appears mid-path, so it is re-extended to cover the whole remainder.
