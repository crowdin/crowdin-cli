...
export CROWDIN_E2E_BASE_URL=https://acme.api.crowdin.com # Crowdin Enterprise only
bun run test:e2e
...
| `CROWDIN_E2E_BASE_URL` | false | API base URL, e.g. `https://<org>.api.crowdin.com`; defaults to `https://api.crowdin.com` |
