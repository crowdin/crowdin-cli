...
public interface Actions {
    ...
    NewAction<ProjectProperties, ClientDistribution> distributionEdit(String hash, boolean noProgress, boolean plainView, String name, ExportMode exportMode, List<String> files, List<Integer> bundleIds, String branch);
    ...
    NewAction<PropertiesWithFiles, ProjectClient> preTranslate(
        ...
        AutoApproveOption autoApproveOption, Boolean duplicateTranslations,
    ...
    NewAction<ProjectProperties, ProjectClient> fileUploadTranslation(File file, String branch, String dest, String languageId, boolean xliff, boolean plainView, boolean isVerbose);
