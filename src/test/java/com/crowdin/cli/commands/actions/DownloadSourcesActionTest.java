    ...
    public void testDifferentPatterns() throws IOException {
        ...
        when(client.downloadFullProject())
            .thenReturn(ProjectBuilder.emptyProject(Long.parseLong(pb.getProjectId()))
                ...
                .addFile("android.xml", "gettext", 101L, 202L, null, "/%locale%/folder_1/**/%file_name%.xml")
                .addFile("android.xml", "gettext", 102L, 203L, null, "/%locale%/folder_1/**/%file_name%.xml")
    ...
    public void testWithPreserveHierarchyFalse() throws IOException {
        ...
        when(client.downloadFullProject())
            .thenReturn(ProjectBuilder.emptyProject(Long.parseLong(pb.getProjectId()))
                ...
                .addFile("android.xml", "gettext", 101L, 201L, null, "/%locale%/folder_1/**/%file_name%.xml")
                .addFile("android.xml", "gettext", 102L, 202L, null, "/%locale%/folder_1/**/%file_name%.xml")
