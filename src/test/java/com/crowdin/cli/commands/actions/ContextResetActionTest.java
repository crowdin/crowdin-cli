...
public class ContextResetActionTest {
    ...
    public void testContextReset() {
        ...
        ContextResetAction action = new ContextResetAction(
                null,
                null,
                null,
                null,
        ...
        assertEquals("/701/context", req.getPath());
        assertEquals("manual", req.getValue());
    }

    @Test
    public void testContextResetDryrun() {
        ProjectProperties pb = NewProjectPropertiesUtilBuilder.minimalBuilt().build();
