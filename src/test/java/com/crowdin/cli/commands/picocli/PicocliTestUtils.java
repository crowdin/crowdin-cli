...
//        verifyNoMoreInteractions(clientActionMock);
    ...
    void mockActions() {
        ...
        when(actionsMock.bundleBrowse(any()))
                .thenReturn(actionMock);
        when(actionsMock.preTranslate(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), anyBoolean(), anyBoolean(), any(), any(), anyBoolean()))
                .thenReturn(actionMock);
        ...
        when(actionsMock.fileUpload(any(), any(), anyBoolean(), any(), any(), any(), any(), any(), any(), anyBoolean(), anyBoolean(), anyBoolean()))
                .thenReturn(actionMock);
        when(actionsMock.fileUploadTranslation(any(), any(), any(), any(), anyBoolean(), anyBoolean()))
                .thenReturn(actionMock);
